...
class CustomerResourceTest {
    ...
    fun `should create a customer and return 201 status`() {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(URL)
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("Cleber"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Farias"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("cleber@teste.com"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("1000.0"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("47800-000"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua que Leva a Qualquer Lugar"))
    ...
    fun `should update a customer and return 200 status`() {
        ...
        mockMvc.perform(MockMvcRequestBuilders.patch("$URL?customerId=${customer.id}")
            ...
            .andExpect(MockMvcResultMatchers.status().isOk)
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("Cleber Update"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Farias Update"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("3000.0"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("47656-000"))
    ...
    private fun builderCustomerDto(
        firstName: String = "Cleber",
        lastName: String = "Farias",
        cpf: String = "28475934625",
        email: String = "cleber@teste.com",
        income: BigDecimal = BigDecimal.valueOf(1000.0),
        password: String = "102030",
        zipCode: String = "47800-000",
        street: String = "Rua que Leva a Qualquer Lugar",
    ) = CustomerDto(
        firstName = firstName,
        lastName = lastName,
        cpf = cpf,
    ...
    private fun builderCustomerUpdateDto(
        firstName: String = "Cleber Update",
        lastName: String = "Farias Update",
        income: BigDecimal = BigDecimal.valueOf(3000.0),
        zipCode: String = "47656-000",
